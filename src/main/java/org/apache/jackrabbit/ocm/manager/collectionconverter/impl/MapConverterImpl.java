...
public class MapConverterImpl extends AbstractCollectionConverterImpl {
     ...
     * @param mapper
     */
    public MapConverterImpl(Map atomicTypeConverters,
    ...
    private void persistMap( Session session, Node parentNode, String jcrName, Map<String,Object> valueMap ) throws RepositoryException {
    ...
    private void persistList( Session session, Node parentNode, String jcrName, List<Object> valueList ) throws RepositoryException {
        ...
        try {
            ...
            for( Object value : valueList){
            	...
            	String key = "item-" + DF.format(itemno);
            	itemno++;
    ...
    */
    ...
    private Map<String, Object> getMap( Session session, Node node) throws RepositoryException{
